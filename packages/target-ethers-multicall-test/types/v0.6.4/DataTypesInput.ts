...
export interface DataTypesInputMulticall {
  address: string;
  abi: Fragment[];
  ...
  input_bool(input1: boolean, overrides?: CallOverrides): ContractCall<boolean>;
  ...
  input_multiple_structs_with_same_name(
    info1: StructsLib1.InfoStruct,
    overrides?: CallOverrides
  ): ContractCall<StructsLib2.InfoStructOutput>;
  ...
  input_string(input1: string, overrides?: CallOverrides): ContractCall<string>;

  input_struct(
    input1: DataTypesInput.Struct1Struct,
    overrides?: CallOverrides
  ): ContractCall<DataTypesInput.Struct1StructOutput>;

  input_struct2(
    input1: DataTypesInput.Struct2Struct,
    overrides?: CallOverrides
  ): ContractCall<DataTypesInput.Struct2StructOutput>;
  ...
  input_struct3_array(
    input1: DataTypesInput.Struct3Struct[],
    overrides?: CallOverrides
  ): ContractCall<DataTypesInput.Struct3StructOutput[]>;
  ...
  input_tuple(
    ...
    input2: BigNumberish,
    overrides?: CallOverrides
  ): ContractCall<[BigNumber, BigNumber]>;
