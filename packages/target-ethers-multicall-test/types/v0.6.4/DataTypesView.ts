...
export interface DataTypesViewMulticall {
  address: string;
  abi: Fragment[];
  functions: FunctionFragment[];

  view_address(overrides?: CallOverrides): ContractCall<string>;

  view_bool(overrides?: CallOverrides): ContractCall<boolean>;

  view_bytes(overrides?: CallOverrides): ContractCall<string>;

  view_bytes1(overrides?: CallOverrides): ContractCall<string>;

  view_enum(overrides?: CallOverrides): ContractCall<number>;

  view_int256(overrides?: CallOverrides): ContractCall<BigNumber>;

  view_int8(overrides?: CallOverrides): ContractCall<number>;
  ...
  view_stat_array(
    overrides?: CallOverrides
  ): ContractCall<[number, number, number]>;

  view_string(overrides?: CallOverrides): ContractCall<string>;

  view_struct(
    overrides?: CallOverrides
  ): ContractCall<DataTypesView.Struct1StructOutput>;

  view_tuple(overrides?: CallOverrides): ContractCall<[BigNumber, BigNumber]>;

  view_uint256(overrides?: CallOverrides): ContractCall<BigNumber>;

  view_uint8(overrides?: CallOverrides): ContractCall<number>;
}
