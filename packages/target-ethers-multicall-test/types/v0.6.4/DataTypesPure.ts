...
export interface DataTypesPureMulticall {
  address: string;
  abi: Fragment[];
  functions: FunctionFragment[];

  pure_address(overrides?: CallOverrides): ContractCall<string>;

  pure_bool(overrides?: CallOverrides): ContractCall<boolean>;

  pure_bytes(overrides?: CallOverrides): ContractCall<string>;

  pure_bytes1(overrides?: CallOverrides): ContractCall<string>;

  pure_enum(overrides?: CallOverrides): ContractCall<number>;

  pure_int256(overrides?: CallOverrides): ContractCall<BigNumber>;

  pure_int8(overrides?: CallOverrides): ContractCall<number>;
  ...
  pure_string(overrides?: CallOverrides): ContractCall<string>;

  pure_struct(
    overrides?: CallOverrides
  ): ContractCall<DataTypesPure.Struct1StructOutput>;

  pure_tuple(overrides?: CallOverrides): ContractCall<[BigNumber, BigNumber]>;

  pure_uint256(overrides?: CallOverrides): ContractCall<BigNumber>;

  pure_uint8(overrides?: CallOverrides): ContractCall<number>;
}
