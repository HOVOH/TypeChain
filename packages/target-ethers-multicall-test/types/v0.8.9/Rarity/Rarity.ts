...
export interface RarityMulticall {
  address: string;
  abi: Fragment[];
  ...
  balanceOf(owner: string, overrides?: CallOverrides): ContractCall<BigNumber>;

  class(arg0: BigNumberish, overrides?: CallOverrides): ContractCall<BigNumber>;

  classes(id: BigNumberish, overrides?: CallOverrides): ContractCall<string>;
  ...
  level(arg0: BigNumberish, overrides?: CallOverrides): ContractCall<BigNumber>;

  next_summoner(overrides?: CallOverrides): ContractCall<BigNumber>;
  ...
  xp(arg0: BigNumberish, overrides?: CallOverrides): ContractCall<BigNumber>;
