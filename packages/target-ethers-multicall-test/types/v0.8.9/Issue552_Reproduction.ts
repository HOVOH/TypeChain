...
export interface Issue552_ReproductionMulticall {
  address: string;
  abi: Fragment[];
  ...
  bars(
    arg0: BigNumberish,
    overrides?: CallOverrides
  ): ContractCall<Issue552_Reproduction.ObservationParamsStructOutput>;

  input(values: BigNumberish[], overrides?: CallOverrides): ContractCall<void>;
}
